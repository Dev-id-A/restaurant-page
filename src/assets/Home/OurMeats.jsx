...
function OurMeats({lang}) {
  ...
  return (
    <section className="flex flex-row h-140 w-full px-3">
        ...
        <div className="relative flex flex-1 bg-black/30 justify-center items-center px-40">
          <img src="/img/home/marco.png" alt="Frame" className="absolute left-0 bottom-0" />
            <h1 className="font-sancreek text-center text-royal text-4xl uppercase tracking-widest">{homeLang.message[lang]}</h1>
