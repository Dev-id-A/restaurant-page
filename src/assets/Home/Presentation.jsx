...
const presentation = {
  aboutES: "UN VIAJE SENSORIAL ENTRE AROMAS, TEXTURA Y TRADICIÓN.",
  ...
  return (
    <main className="flex flex-col justify-center items-center py-20 font-yrsa text-center text-royal">
      <h1 className="text-5xl">{lang == "es" ? presentation.aboutES:presentation.aboutEN}</h1>
        <p className="text-4xl mt-20 px-100">{lang == "es" ? presentation.descriptionES:presentation.descriptionEN}</p>
    </main>
  )
}
