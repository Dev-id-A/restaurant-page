function MenuBtn({children, image}) {
  return (
    <button className="relative border size-full hover:cursor-pointer group">
    ...
    <div className="absolute inset-0 bg-black/60 group-hover:bg-black/10 group-hover:scale-102 transition-all duration-1000"></div>
      ...
      <h2 className="text-5xl text-white absolute inset-0 flex justify-center z-10">{children}</h2>
