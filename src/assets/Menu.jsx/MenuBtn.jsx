function MenuBtn({children, image, menu}) {
  return (
    <button className="relative border size-full hover:cursor-pointer group border-royal" onClick={()=> window.open(`${menu}`, "_blank")}>
      ...
      <h2 className="text-5xl text-royal absolute inset-0 top-5 flex justify-center z-10 group-hover:scale-102 transition-all duration-1000">{children}</h2>
